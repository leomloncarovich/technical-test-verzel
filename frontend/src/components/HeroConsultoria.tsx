  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 sm:py-8 md:py-10">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-2xl backdrop-blur sm:p-5 md:p-6 text-center">
          ...
          <p className="mb-4 text-sm leading-relaxed text-slate-200/90 sm:text-base md:text-base mx-auto max-w-2xl">
            Identificamos o seu gargalo operacional (rotas, estoque, regiões críticas, controle de entrada/saída)
            e marcamos uma reunião onde <strong className="text-sky-300">especialistas em logística</strong> irão participar para apresentar uma solução personalizada.
          </p>

          <ul 
            className="mb-4 grid gap-1.5 text-xs text-slate-200/80 sm:text-sm md:text-sm mx-auto max-w-xl"
            role="list"
            aria-label="Benefícios do serviço"
          >
            <li className="flex items-start justify-center gap-2">
              <CheckIcon 
                className="mt-0.5 h-4 w-4 flex-none text-sky-300 sm:h-5 sm:w-5" 
                aria-hidden="true"
              />
          ...
          <p className="text-xs text-slate-300/70 sm:text-sm md:text-sm mx-auto max-w-xl">
            <strong className="text-sky-300">Comece agora:</strong> Digite sua mensagem no chat abaixo para iniciar o diagnóstico.
          </p>
        </div>
      </div>
    </section>
